...
class Fraction:
    ...
    def __str__(self):
        ...
        """
        return f"{self.__simpleNum}/{self.__simpleDen}"
...
if __name__ == "__main__":
    ...
    print(f"frac 1 : Fraction(4, -5)\n"
          f"frac 2 : Fraction(-10,-5)")
    frac1 = Fraction(4, -5)
    frac2 = Fraction(-10, -5)
    print(f"fraction 1 : {frac1.__str__()}")
    print(f"fraction 2 : {frac2.__str__()}")
    print(f"as_mixed_number : {frac1.as_mixed_number()}")
    print(f"__add__ : {frac1.__add__(frac2)}")
    print(f"__sub__ : {frac1.__sub__(frac2)}")
    print(f"__mul__ : {frac1.__mul__(frac2)}")
    print(f"__truediv__ : {frac1.__truediv__(frac2)}")
    print(f"__pow__ : {frac1.__pow__(frac2)}")
    print(f"__eq__ : {frac1.__eq__(frac2)}")
    print(f"__float__ : {frac1.__float__()}")
    print(f"is smaller : {frac1.is_smaller(frac2)}")
    print(f"is bigger : {frac1.is_bigger(frac2)}")
    print(f"inverted : {frac1.inverted()}")
    print(f"is_zero : {frac1.is_zero()}")
    print(f"is integer : {frac1.is_integer()}")
    print(f"is proper : {frac1.is_proper()}")
    print(f"is unit : {frac1.is_unit()}")
    print(f"is_adjacent_to : {frac1.is_adjacent_to(frac2)}")
